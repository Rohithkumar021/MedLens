          ...
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <div className="flex items-center gap-2">
                <h3 className="text-base font-extrabold tracking-tight">8-Stage Traceable Evidence Chain</h3>
                <span className="text-[10px] font-mono px-2 py-0.5 bg-sky-500/20 text-sky-300 rounded border border-sky-400/30 uppercase">
                  Verified Lineage
                </span>
              </div>
          ...
          <div className="flex items-start gap-3.5 p-3.5 bg-slate-50 rounded-xl border border-slate-200">
            ...
            <div className="flex-1 space-y-1">
              <div className="flex items-center justify-between">
                ...
                <span className="text-[10.5px] font-mono font-bold text-slate-600 bg-slate-200/80 px-2 py-0.5 rounded">
                  Page {observation.source_page || 1}
                </span>
              </div>
              <div className="p-2.5 bg-slate-950 text-slate-200 font-mono text-xs rounded-lg border border-slate-800 leading-relaxed select-text mt-1">
            ...
            <div className="flex-1 space-y-2">
              <div className="flex items-center justify-between">
                ...
                <span className={`text-[10px] uppercase font-bold px-2 py-0.5 rounded ${
                  observation.is_reviewed ? 'bg-emerald-100 text-emerald-800' : 'bg-amber-100 text-amber-800'
                }`}>
              ...
              {observation.review_records && observation.review_records.length > 0 && (
                <div className="space-y-1">
                  <div className="text-[10px] font-bold text-slate-400 uppercase flex items-center gap-1">
                    <History className="w-3 h-3" /> Historical Audit Trail
                  </div>
