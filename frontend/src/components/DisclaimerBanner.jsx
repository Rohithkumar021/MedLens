...
export default function DisclaimerBanner() {
  return (
    <div className="bg-slate-100 text-slate-700 border-b border-slate-200 px-4 py-2 text-xs select-none">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <ShieldCheck className="w-4 h-4 text-brand-600 shrink-0" aria-hidden="true" />
          <span className="font-bold tracking-wide text-brand-700 uppercase text-[11px]">
            Clinical Intelligence &amp; Provenance System:
          </span>
          <span className="text-slate-600 hidden md:inline text-[11px] leading-tight">
            MedLens organizes and explains facts from provided records. It does not provide medical diagnoses or prescribe treatments.
          </span>
          <span className="text-slate-600 md:hidden text-[11px]">
