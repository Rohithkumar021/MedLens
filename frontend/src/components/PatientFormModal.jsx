      ...
      <div className="bg-white rounded-2xl shadow-modal border border-slate-200 w-full max-w-2xl overflow-hidden animate-modal-in">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 max-h-[78vh] overflow-y-auto">
          ...
          <div className="space-y-3">
            <div className="text-xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 pb-1 font-mono">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div className="sm:col-span-2">
                ...
                <input
                  ...
                  className="w-full px-3 py-1.5 text-xs font-semibold bg-white border border-slate-300 text-slate-900 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none"
                />
              </div>
              <div>
            ...
            <div>
              ...
              <div className="flex gap-2 mb-2">
                <input
                  ...
                  className="flex-1 px-3 py-1.5 text-xs bg-white border border-slate-300 text-slate-900 rounded-lg focus:ring-2 focus:ring-brand-500 focus:outline-none"
                />
                <button
                  type="button"
                  onClick={() => handleAddItem(currentSymptom, setCurrentSymptom, symptoms, setSymptoms)}
                  className="px-3 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 rounded-lg text-xs font-bold flex items-center gap-1 transition"
                >
          ...
          <div className="space-y-3 pt-2">
            <div className="text-xs font-bold uppercase tracking-wider text-slate-400 border-b border-slate-100 pb-1 flex items-center justify-between font-mono">
              ...
              <div>
                ...
                <div className="flex gap-2 mb-2">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-300 rounded-lg text-xs font-bold transition"
                  >
                    Add
                  </button>
                </div>
