    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white rounded-2xl shadow-modal border border-slate-200 w-full max-w-lg overflow-hidden animate-modal-in">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          ...
          <div className="grid grid-cols-3 gap-2 text-center text-[10px] font-bold text-slate-500 pb-1 font-mono">
          ...
          >
            ...
            {file ? (
              ...
              <label htmlFor="file-upload" className="cursor-pointer flex flex-col items-center gap-2">
                <div className="p-2.5 bg-white rounded-full shadow-subtle border border-slate-200 text-brand-600">
                ...
                <p className="text-[11px] text-slate-400 font-mono">Supported formats: PDF, TXT, JSON (Max 10MB)</p>
              </label>
            )}
          </div>
          ...
          <div className="p-3 bg-sky-50 border border-sky-200 rounded-xl flex items-center justify-between gap-3 text-xs">
            <div>
              <span className="font-bold text-slate-900 text-xs">Need a synthetic lab report to test?</span>
              <p className="text-slate-600 text-[11px]">Download synthetic PDF with normal, high, and missing range values.</p>
            </div>
            <a
