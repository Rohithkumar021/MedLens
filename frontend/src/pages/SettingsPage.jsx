...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-12">
      ...
      <div className="bg-slate-900/80 backdrop-blur-md rounded-2xl border border-slate-800 p-6 shadow-elevation space-y-4">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            ...
            <div className="p-3.5 bg-slate-950/70 rounded-xl border border-slate-800">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider font-mono">Service Status</div>
              <div className="font-extrabold text-emerald-400 text-xs mt-1 flex items-center gap-1.5 font-mono">
            ...
            <div className="p-3.5 bg-slate-950/70 rounded-xl border border-slate-800">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider font-mono">Environment</div>
            ...
            <div className="p-3.5 bg-slate-950/70 rounded-xl border border-slate-800">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider font-mono">AI Provider</div>
              <div className="font-bold text-slate-200 text-xs mt-1">
                {health.ai_provider}
              </div>
            </div>
            ...
            <div className="p-3.5 bg-slate-950/70 rounded-xl border border-slate-800">
              <div className="text-[10px] text-slate-400 font-bold uppercase tracking-wider font-mono">Synthesis Engine</div>
              <div className="font-bold text-xs mt-1">
                {health.gemini_configured ? (
                  ...
                  <span className="text-amber-400 flex items-center gap-1 font-mono" title="Zero-downtime deterministic fallback active">
                    <Cpu className="w-3.5 h-3.5" /> Deterministic Engine
                  </span>
                )}
              </div>
            </div>
      ...
      <div className="bg-slate-900/80 backdrop-blur-md text-slate-200 rounded-2xl p-6 shadow-elevation space-y-4 border border-slate-800">
        <h3 className="text-xs font-bold uppercase tracking-wider text-sky-400 flex items-center gap-2 font-mono">
