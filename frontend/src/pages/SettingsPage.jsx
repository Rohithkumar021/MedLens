...
export default function SettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-4xl pb-12">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
            <div className="p-3 bg-slate-50 rounded-xl border border-slate-200">
              ...
              <div className="font-extrabold text-emerald-700 text-xs mt-1 flex items-center gap-1.5 font-mono">
      ...
      <div className="bg-white text-slate-900 rounded-2xl p-6 shadow-card space-y-4 border border-slate-200">
        <h3 className="text-xs font-bold uppercase tracking-wider text-brand-700 flex items-center gap-2 font-mono">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-xs">
          <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
            <div className="font-extrabold text-slate-900">1. Deterministic Reference Ranges</div>
          ...
          <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
            <div className="font-extrabold text-slate-900">2. Non-Diagnostic &amp; Non-Prescriptive</div>
            <p className="text-slate-600 text-[11px] leading-relaxed">
          ...
          <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
            <div className="font-extrabold text-slate-900">3. Complete Provenance Tracking</div>
            <p className="text-slate-600 text-[11px] leading-relaxed">
          ...
          <div className="p-3.5 bg-slate-50 rounded-xl border border-slate-200 space-y-1">
            <div className="font-extrabold text-slate-900">4. Human Review &amp; Audit Trail</div>
            <p className="text-slate-600 text-[11px] leading-relaxed">
